...
const ServicingCenter = () => {
  ...
  <div className='max-w-6xl mx-auto'>
    {/* heding section */}
       <div className='text-center pt-10'>
          <h1 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-black'>Welcome to Our Servicing Center</h1>
          <h3 className='text-sm sm:text-base md:text-lg lg:text-xl pt-2 text-black font-semibold'>Professional Repair & Support For All Your Devices</h3>
                    <p className='sm:text-xs md:text-md lg:text-xl text-black sm:px-10 lg:px-50 pt-3'>We have our own servicing center. If you want, you can bring it directly, or we will collect it from your home and deliver it back after the repair and set it up. Call now for fast service.</p>
                        <div className='flex gap-2 justify-center pt-5 pb-3 px-20 sm:px-10 lg:px-20'>
                             <h1 className='flex justify-between items-center text-[#0000FF] px-2 py-2 font-semibold gap-2 border-2 rounded-xl'>Contact: 01615458942</h1>
                             <h1 className='flex justify-between items-center text-[#000080] px-2 py-2 font-semibold gap-2 border-2 rounded-xl'>Whatsapp: 01782299570</h1>
                        </div>
 ...
 <div className="w-full lg:w-1/2">
  <h1 className="text-2xl font-bold mb-2 mt-3 text-black px-2">Service Center Location</h1>
   <h3 className='text-xl text-black px-2'>Location: Khagan Ashulia Savar</h3>
   <h3 className='text-lg text-black px-2 pb-5'>Service time: 4:00 PM – 10:00 PM</h3>
    <iframe
